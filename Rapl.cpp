...
void Rapl::reset() {
	...
	for(j=0;j<total_packages;j++){
		...
		running_total[j].pkg = 0;
		running_total[j].pp0 = 0;
		running_total[j].pp1 = 0;
		running_total[j].dram = 0;
		running_total[j].psys = 0;
		...
		current_state[j]->pkg = 0;
		current_state[j]->pp0 = 0;
		current_state[j]->pp1 = 0;
		current_state[j]->dram = 0;
		current_state[j]->psys = 0;
